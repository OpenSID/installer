...
<div class="form-group">
	...
	<div class="table-responsive">
		<table class="table no-margin">
			...
			<tbody>
				<?php $hasError = []; ?>
				<?php foreach ($server['versi'] as $key => $value):?>
				<tr>
					...
					<?php $hasError[$key] = ['message' => 'Silahkan install' . strtoupper($key) . 'dengan versi yang lebih tinggi dari' . $value['requirement']];?>
					<?php endif;?>
				</tr>
				<?php endforeach ?>
			</tbody>
...
<div class="form-group">
	...
	<div class="table-responsive">
		<table class="table no-margin">
			...
			<tbody>
				<?php foreach ($server['config'] as $key => $value):?>
				<tr>
					<td><?= $key ?></td>
					<td><?= $value['requirement'] ?></td>
					...
					<?php else:?>
						<td> <span class='label label-danger'>FAIL</span></td>
					<?php $hasError[$key] = ['message' => 'Silahkan ubah ' . $key . ' di file php.ini'
						];?>
					<?php endif;?>
					</tr>
				<?php endforeach;?>
			...
			<tbody>
				<?php foreach ($server['config'] as $key => $value):?>
					<tr>
						...
						<?php else: ?>
							<td> <span class='label label-danger'>FAIL</span></td>
						<?php $hasError[$key] = ['message' => 'Silahkan load extensions' . $key . ' (Windows dengan mengubah file php.ini, Linux dengan menginstall extensi tersebut)'
							];?>
						<?php endif;?>
					</tr>
				<?php endforeach;?>
	...
	<div class="form-group">
		...
		<div class="table-responsive">
			<table class="table no-margin">
				...
				<tbody>
					<?php foreach ($hasError as $key => $value):?>
						<tr>
							<td><?= $key ?></td>
							<td><?= $value['message'] ?></td>
						</tr>";
